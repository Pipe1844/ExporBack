...
public partial class KnDatosPorTurnoVw
{
    ...
    public double? NetoExpPromedioPcamion { get; set; }

    public double? SumPesoNIngenio { get; set; }

    public double? PesoNIngenioPromedioPcamion { get; set; }

    public double? SumPesoNApagarIngenio { get; set; }

    public double? PesoNApagarIngenioPromedioPcamion { get; set; }

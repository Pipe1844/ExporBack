...
public partial class FtMonitoreoPlagasTbDdtVw
{
    ...
    public int MoscaBlancaTotal { get; set; }
    ...
    public int? MinadorTotal { get; set; }

    public int? AfidosTotal { get; set; }

    public int? DiafaniaTotal { get; set; }

    public int? SpodopteraTotal { get; set; }

    public int? LfrutoTotal { get; set; }

    public int? PlagasTotal { get; set; }
